...
- (void)rematchWithMatch:(GKTurnBasedMatch *)inMatch
{
    ...
    [inMatch rematchWithCompletionHandler:^(GKTurnBasedMatch *match, NSError *error) {
        if (error) {
            UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"Oops" message:@"Error occured, please try again" delegate:nil cancelButtonTitle:nil otherButtonTitles:nil];
            [alertView show];
        }
        else
        {
...
(GKTurnBasedMatchmakerViewController *)viewController
    ...
    if (firstParticipant.lastTurnDate == NULL) {
        ...
        if (statusString == nil) {
            ...
            UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"Match status\n" message:statusString delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
            [alertView show];
        }
    }
}
