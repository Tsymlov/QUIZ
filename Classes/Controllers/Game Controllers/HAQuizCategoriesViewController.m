...
- (void)playQuizAtIndex:(NSInteger)inIndex
{
    ...
    {
        UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"" message:[NSString stringWithFormat:@"category_questions_max_limit is set to zero or key is missing for the category %@ and also make sure this count should not be more than number of questions in the Quetions_Category_%@",categoryName,quizId] delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alertView show];
        return;
    }
