...
@interface HAMainViewController : UIViewController <GKGameCenterControllerDelegate, HATurnbasedMatchHelperDelegate, UIAlertViewDelegate>
{
...
@property (nonatomic, strong) IBOutlet UIView* _gcTopBannerView;
@property (nonatomic, strong) IBOutlet UILabel* _gcBannerMessageLabel;
