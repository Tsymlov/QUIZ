...
- (void)viewDidLoad
{
    ...
    if ([HASettings sharedManager]._isGameCenterSupported)
    {
        ...
        if (leaderboardID == nil) {
            UIAlertView* alertview = [[UIAlertView alloc] initWithTitle:@"" message:[NSString stringWithFormat:@"Gamecenter feature is enabled in \"Congiguration.plist\" file and leaderboard id is not added to category \"%@\"  ",[[HAQuizDataManager sharedManager]._currentCategoryDict objectForKey:kQuizCategoryName]] delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
            [alertview show];
            return;
...
- (IBAction)facebookShareAction:(id)sender
{
    ...
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeFacebook])
    {
        ...
        UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"Facebook" message:@"Login to your Facebook account in device settings and try again." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alertView show];
    }
}
- (IBAction)twitterShareAction:(id)sender
{
    ...
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeTwitter]) {
        ...
        UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"Twitter" message:@"Login to your Twitter account in device settings and try again." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alertView show];
    }
