...
- (void)buyProduct:(SKProduct *)product {
    ...
    {
        UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"" message:@"Device is not connected to Internet." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alertView show];
        return;
    }
    ...
    {
        UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"" message:@"Unable to buy at this time, please try later" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alertView show];
        return;
    }
...
//        [alertView show];
    ...
    if (response.products.count == 0) {
        ...
        UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"" message:@"Products not loaded, please try later." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alertView show];
    }
}
...
- (void)failedTransaction:(SKPaymentTransaction *)transaction {
    ...
    if (transaction.error.code != SKErrorPaymentCancelled)
    {
        ...
        UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"" message:transaction.error.localizedDescription delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alertView show];
    }
